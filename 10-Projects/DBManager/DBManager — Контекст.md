...
**Оновлено:** 2026-06-19
**Стан:** Реалізовано панель геосимуляції в адмінці WP плагіна, автоматичне виконання шорткодів у ACF полях, `the_title`, `the_excerpt`. Проведено повний модульний рефакторинг плагіна (виділено ShortcodeController, FilterController, CronController, RestController, GeoSimulation). Створено гайд з підключення. Тести плагіна проходять на 100%.
