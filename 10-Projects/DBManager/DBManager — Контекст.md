...
- Ручний клік по сайту в лівому списку автоматично перемикає область на **Вибрані сайти**, щоб вибір одразу впливав на цілі операції.
...
- `docker compose exec -T core php artisan test tests/Feature/Admin/BulkOperationsTest.php` — 6 тестів, 26 assertions.
